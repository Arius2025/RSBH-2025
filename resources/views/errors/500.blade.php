    ...
    <div class="row justify-content-center">
        <div class="col-md-8 text-center" data-aos="fade-up">
            <div class="error-container py-5">
                <i class="bi bi-gear-fill display-1 text-warning mb-4 d-block"></i>
                <h1 class="display-3 fw-bold text-dark">500</h1>
                <h2 class="h3 fw-bold text-warning mb-3">Kesalahan Server Internal</h2>
                <p class="text-muted fs-5 mb-5 mx-auto" style="max-width: 500px;">
                    Terjadi kesalahan pada server kami. Kami sedang berusaha memperbaikinya segera.
                </p>
