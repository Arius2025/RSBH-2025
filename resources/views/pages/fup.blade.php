...
<style>
    ...
    .pulse-indicator {
        width: 10px; height: 10px; background: #1b1987ff; border-radius: 50%;
        display: inline-block; animation: pulse-green 2s infinite; margin-right: 8px;
    }
    .status-badge {
        background: rgba(25, 135, 84, 0.08); color: #1b1987ff; font-size: 0.65rem;
        ...
        <div class="col-lg-5">
            <div class="form-section p-4 luxury-shadow glass-card border-0">
                <h5 class="fw-bold mb-4 d-flex align-items-center text-primary">
                    <span class="bg-primary text-white rounded-circle p-2 me-3 d-flex shadow-sm">
                        <i class="bi bi-phone-fill fs-6"></i>
                    </span>
                    FUP KOPI
                </h5>
                ...
                <div class="mb-4 text-center">
                    <span class="status-badge">
                        <span class="pulse-indicator"></span> Follow Up Pasien Kemoterapi
                    </span>
                </div>
